...
public class BootReminder extends BroadcastReceiver {
    private static final String PROFILE_OWNER_PACKAGE = "com.afwsamples.testdpc";
    private static final String PROFILE_OWNER_CLASS = PROFILE_OWNER_PACKAGE + ".DeviceAdminReceiver";
